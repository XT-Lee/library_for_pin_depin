...
class initial_state_generator:
    ...
    def get_gsd_sample(self, simu_index=4302, seed=9, account='remote'):
        ...
        # [0]*N_particles, the value of the i-th element means the type('A'or'B') of the i-th particle.
        print(self.snap.particles.typeid)
    ...
    # checked right
    def set_new_gsd_file_2types_by_box_or_n_size(
            self, particle_pointer, trap_pointer, output_gsd_filename, perturb=False, box=None,
            n_size=None):
        R"""
        introduction:
        ...
        # cut_edge_of_positions_by_xylimit(-0.5*bx[0],0.5*bx[0],-0.5*bx[1],0.5*bx[1])
        pd.cut_edge_of_positions_by_box(trap_positions, box)
    ...
    def set_new_gsd_file(
            self, particle_pointer, output_gsd_filename, perturb=False, box=None, n_size=None):
        R"""
            lattice_pointer: 
                lp = workflow_analysis.archimedean_tilings(), after lp.generate_typex(),
                lp.a1,lp.a2,lp.a3 are lattice constant;
