...
class static_points_analysis_2d:#old_class_name: PointsAnalysis2D
    ...
    def get_conditional_bonds_and_simplices_vertex_length(self,ridge_first_minima_left=None):#long_bond_cutoff=6,
        ...
        record_vertices_cluster[:,1]=-record_vertices_cluster[:,1]#-1 has been marked as infinity point
        ...
        list_vertices_index_all = np.unique(self.voronoi.ridge_vertices).astype(int)#truly exist a vertex whose id is -1!
        ...
        record_vertices_cluster[:,1] = record_vertices_cluster[:,1]+n_tris#ensure that ids are not overlapped
